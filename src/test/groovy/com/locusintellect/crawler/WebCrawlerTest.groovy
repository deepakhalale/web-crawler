...
import static com.locusintellect.domain.DomainLinks.EMPTY_DOMAIN
...
class WebCrawlerTest {
    ...
    private DomainLinks getExpectedNestedDomainLinks() {
        DomainLinks contactDomain = builder()
                ...
                .linksWithinDomain(["/contact1": EMPTY_DOMAIN("${STARTING_URL}/contact1")])
                .build()

        DomainLinks blogDomain = builder()
                .domain("${STARTING_URL}/blog")
                .staticContentLinks(["/blog/static/link"] as Set)
                .externalLinks(["https://google.com/builditdigital"] as Set)
                .linksWithinDomain(["/blog1": EMPTY_DOMAIN("${STARTING_URL}/blog1"), "blog2": EMPTY_DOMAIN("${STARTING_URL}/blog2")])
                .build()
    ...
    private void givenNestedDomainLinksExistForRootDomain() {
        ...
        given(pageCrawler.crawlPageForLinks("${STARTING_URL}/contact1")).willReturn(EMPTY_DOMAIN("${STARTING_URL}/contact1"))
        ...
        given(pageCrawler.crawlPageForLinks("${STARTING_URL}/blog1")).willReturn(EMPTY_DOMAIN("${STARTING_URL}/blog1"))
        given(pageCrawler.crawlPageForLinks("${STARTING_URL}/blog2")).willReturn(EMPTY_DOMAIN("${STARTING_URL}/blog2"))
        ...
        DomainLinks rootDomain = builder()
                .domain("${STARTING_URL}/")
                .staticContentLinks(["/frontend/images/logo.png"] as Set)
                .externalLinks(["https://www.facebook.com/bidtulsa/"] as Set)
